    ...
    <Layout>
      ...
      <Layout>
        ...
        <p>
          ...
          Сбер-Пульса или Линкедина). Основные приколы: календарь, лента, посты,
          комментарии, профиль, стена, поиск, уведомления, сложные таблицы.
          <br />
          Стек:
          <ul>
            <li>Vue2</li>
        ...
        <p>
          ...
          крупного ру-застройщика (вы о нем точно слышали). Основные достижения:
